        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <p className="font-mono text-foreground">{property.longtitude}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
          ...
          <div className="space-y-6">
            ...
            {property.rooms && property.rooms.length > 0 && (
              <Card>
                <CardContent className="pt-6">
                  <h3 className="text-lg font-semibold text-foreground mb-4">Daftar Ruangan</h3>
                  <div className="space-y-4">
                    {property.rooms.map((room) => (
                      <div
                        key={room.id}
                        className="p-4 border rounded-lg flex flex-col gap-2 hover:shadow-sm transition"
                      >
